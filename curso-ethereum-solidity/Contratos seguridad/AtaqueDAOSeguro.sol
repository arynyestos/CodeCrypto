...
contract Victima {
    ...
    bool internal bloqueo;

    function deposito() external payable{
        saldos[msg.sender] += msg.value;
    }

    modifier olvidateDeHacermeUnReingreso(){
        require(!bloqueo, "Mala suerte, atacante.");
        bloqueo = true;
        _;
        bloqueo = false;
    }

    function retiroDeDinero() external olvidateDeHacermeUnReingreso {
